...
### 2. Accounting for differences in lab split, sampling methods, etc. 
...
**Rules as of 05-22**:
  ...
  * Drop egg, exuvia, & unspecified life stages. 
...
Drop eggs, exuvia, and unspecified:
...
```{r}
sample_richness <- taxa_meta_stage %>%
...
```{r}
write.csv(site_yr_longterm, "cleaned_data/longterm_site_richness.csv")
```
